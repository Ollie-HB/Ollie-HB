...
**Bank tech test** | Challenge to practice writing clean, test-driven code. Simple bank program that allows users to deposit and withdraw money from a bank account and recieve a formatted bank statement. 🏦 | JavaScript, Node, Jest|[Code](https://github.com/Ollie-HB/bank-tech-test) | 2 days / Solo challenge |
